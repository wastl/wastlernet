...
namespace senec {
    ...
    public:
        SenecModule(const wastlernet::TimescaleDB& db_cfg, const wastlernet::Senec& client_cfg)
                : wastlernet::PollingModule<SenecData>(db_cfg, new SenecWriter, client_cfg.poll_interval()),
                  uri(client_cfg.host()) {}
    };
};
